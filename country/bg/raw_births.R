...
# Births data
years <- 2013:2023
births <- c(66578, 67585, 65950, 64984, 63955, 62197, 61538, 59086, 58678, 56596, 57197)
...
write.csv(data, 'data/bg/births_by_year.csv')
...
ggplot(data, aes(x = year, y = births)) +
  ...
  geom_text(aes(label = ifelse(year >= 2020, paste0(round(deviation, 1), "%"), "")),
            vjust = -1, size = 6) +
  labs(title = "BG - Births and Deviation from Linear Trend (2013-2019)",
       x = "Year",
       y = "Number of Births",
